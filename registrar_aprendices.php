...
<head>
  ...
  <title>Registrar Aprendiz | Oferta Complementaria</title>
  <meta property="og:title" content="Registrar Aprendiz | Oferta Complementaria">
...
<?php if(!empty($user)): ?>
    ...
    <div class="mt-2 PopUpContainer">
        <div class="contentContainer">
            <ol class="breadcrumb"><li><a href="index.php">Inicio</a></li><li><a href="micuenta.php">Mi cuenta</a></li><li class="active">Registrar Aprendiz</li></ol>
        </div>
        <!-- ====== PopUpLogin ======-->
                            ...
                            <div class="full-width">
                                <form class="simple_form mt-2" id="frmGuardarAprendiz">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <button type="button" id="btnGuardarAprendiz" class="btn btn-outline-primary btn-block">Registrar Aprendiz</button>
                                    </div>
                                    </div>
                                </form>   
